...
public class ConvertAmountsTest extends AbstractTest {
    ...
    void get_shouldReturn200() throws IOException, URISyntaxException {
        ...
        org.max.home.spoon.ConvertAmountsDto bodyResponse = new org.max.home.spoon.ConvertAmountsDto();
        ...
        assertEquals("Answer", mapper.readValue(response.getEntity().getContent(), org.max.home.spoon.ConvertAmountsDto.class).getAnswer());
